...
print("A");
//vecteurs Except 68040+162Bug
MapEspaceVirtuel(ArbreS,
		(char*)0x0000,(char*)(0x9000-1),
		TRANSPARANT,(char*)0);//modeS
//code e2s 2 pages
MapEspaceVirtuel(ArbreS,
		(char*)0x10000,(char*)(0x10000+2*4096-1),
		TRANSPARANT,(char*)0);//modeS
print("B");

//ssp e2s 1 page
MapEspaceVirtuel(ArbreS,
		(char*)(0x400000-4096),(char*)0x3FFFFF,
		TRANSPARANT,(char*)0);  //modeS
