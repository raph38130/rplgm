...
; Version 2.3.7 Thu Feb  5 13:36:48 2004
...
_main:
	...
	ar0 = 0x00
	ar1 = 0x01
;	essai.c:22: printf("hello LGM V0.2.5!!!\r\n"); 
;	genIpush 
	mov	a,#__str_0
	push	acc
	mov	a,#(__str_0 >> 8)
...
;	genSend argreg = 1, size = 1 
	mov	dpl,#0x6E
	lcall	_romInit
;	essai.c:24: printf("after init_rom!!!\r\n");
;	genIpush 
	mov	a,#__str_1
	push	acc
	mov	a,#(__str_1 >> 8)
